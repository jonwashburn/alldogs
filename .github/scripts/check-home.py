...
assert [attrs['data-art-name'] for tag, attrs in pages['index.html'].tags if 'data-art-name' in attrs] == ['Barack', 'Undertow', 'Tideheart']
...
for phrase in ('seven days', 'One direct adoption per person, ever.', 'not open yet', 'does not reserve a dog'):
