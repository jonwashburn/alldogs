(() => {
  ...
  function lounge() {
    ...
    if(account.hasInvitation&&!app){const c=card('Your invitation.');c.append(node('p','Wubbushi has chosen three dogs for you.'),link('Come into the garden ↗','/viewing-room/','button primary'));return;}
